...
public class LWJGLGameWindow implements GameWindow, Runnable
{
    ...
    private byte timeToChangeHealth = 75;
    ...
    private void gameLoop()
    {
        ...
        while (game.running)
        {
            ...
            timedelta = Math.min(timedelta + 1.5f, desiredDelta);
            float delta = timedelta / desiredDelta;
